 ...
 * 撑不出问题）。选择列只有 `EDGE_COL` 减去左右 `px-md` 那点内容宽——下面的数字
 * 是列宽还随密度变化时（2026-08-12）量的；2026-09-15 起列宽固定 64px，内容宽只会
 * 更宽，结论不变。当时 default 密度下量出来是 24px，checkbox 本体 16px 居中，两侧各只剩 4px 富余，`-lg`
