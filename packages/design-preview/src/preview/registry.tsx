        ...
        <ShellHeader
          ...
          leading={
            <>
              ...
              <ShellHeaderMark src={brandMark.src} href="#home" />
              <ShellHeaderDivider />
              {/* 产品标识由产品侧提供；这里用平台标识占位。 */}
              <ShellProductTitle
                logoSrc={brandMarkV.src}
                name="产品"
                type="产品类型"
