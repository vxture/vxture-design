...
export const NAMESPACES = [
  {
    ns: "font-weight",
    file: "typography/weight-primitive.css",
    title: "字重",
    utility: "font-*",
  },
  {
    ns: "text-shadow",
    file: "text-shadow-primitive.css",
    title: "文字阴影",
    utility: "text-shadow-*",
  },
  {
    ns: "inset-shadow",
    file: "inset-shadow-primitive.css",
    title: "内阴影",
    utility: "inset-shadow-*",
  },
  {
    ns: "drop-shadow",
    file: "drop-shadow-primitive.css",
    title: "投影滤镜",
    utility: "drop-shadow-*",
  },
  {
    ns: "color",
    file: "color-primitive.css",
    title: "色板",
    utility: "bg-* / text-* / border-*",
  },
  {
    ns: "font",
    file: "typography/font-primitive.css",
    title: "字体栈",
    utility: "font-*",
  },
  {
    ns: "text",
    file: "typography/text-primitive.css",
    title: "字号",
    utility: "text-*",
  },
  {
    ns: "tracking",
    file: "typography/tracking-primitive.css",
    title: "字距",
    utility: "tracking-*",
  },
  {
    ns: "leading",
    file: "typography/leading-primitive.css",
    title: "行高",
    utility: "leading-*",
  },
  {
  ...
  {
    ns: "container",
    file: "container-primitive.css",
    title: "容器宽度",
    utility: "max-w-*",
  },
  {
    ns: "spacing",
    file: "spacing-primitive.css",
    title: "间距基数",
    utility: "p-* / gap-* / size-*",
  },
  {
    ns: "radius",
    file: "radius-primitive.css",
    title: "圆角",
    utility: "rounded-*",
  },
  {
    ns: "shadow",
    file: "shadow-primitive.css",
    title: "阴影",
    utility: "shadow-*",
  },
  ...
  {
    ns: "perspective",
    file: "perspective-primitive.css",
    title: "透视",
    utility: "perspective-*",
  },
  {
    ns: "aspect",
    file: "aspect-primitive.css",
    title: "宽高比",
    utility: "aspect-*",
  },
  {
    ns: "ease",
    file: "ease-primitive.css",
    title: "缓动曲线",
    utility: "ease-*",
  },
  {
    ns: "animate",
    file: "animate-primitive.css",
    title: "动画",
    utility: "animate-*",
  },
